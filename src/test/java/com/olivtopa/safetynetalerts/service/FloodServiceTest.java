...
public class FloodServiceTest {
	 ...
	 @Mock
		...
		public void adressReturnFoyer() {
			...
			// WHEN
			List<FloodFoyer> result = floodService.floodPersonListByAddress("address1");

			// THEN
			Assertions.assertThat(result).extracting(FloodFoyer::getFirstName, FloodFoyer::getLastName, FloodFoyer::getPhone)
